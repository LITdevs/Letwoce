...
namespace Lettuce.Migrations
{
    ...
    [Migration("20251110152035_FixKilledBy")]
    partial class FixKilledBy
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Lettuce.Database.Models.PlayerCountLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("PlayerCountLogs");
                });

            modelBuilder.Entity("Lettuce.Database.Models.Vote", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Lettuce.Database.Models.Pawn", b =>
                {
                    b.HasOne("Lettuce.Database.Models.Pawn", "KilledBy")
                        .WithMany()
            ...
            modelBuilder.Entity("Lettuce.Database.Models.Vote", b =>
                {
                    b.HasOne("Lettuce.Database.Models.Event", "Drop")
                        .WithMany()
                        .HasForeignKey("DropId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Lettuce.Database.Models.Pawn", "Votee")
                        .WithMany()
                        .HasForeignKey("VoteeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Lettuce.Database.Models.Pawn", "Voter")
                        .WithMany()
